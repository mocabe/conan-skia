...
| Linux (clang) | ![build](https://github.com/mocabe/conan-skia/actions/workflows/ubuntu-latest-clang-shared.yml/badge.svg) | ![build](https://github.com/mocabe/conan-skia/actions/workflows/ubuntu-latest-clang-static.yml/badge.svg) |
| Linux (gcc)   | ![build](https://github.com/mocabe/conan-skia/actions/workflows/ubuntu-latest-gcc-shared.yml/badge.svg) | ![build](https://github.com/mocabe/conan-skia/actions/workflows/ubuntu-latest-gcc-static.yml/badge.svg) |
